...
import (
	...
	"github.com/displague/crossplane-provider-linode/apis"
	"github.com/displague/crossplane-provider-linode/pkg/controller"
)
...
func main() {
	...
	log := logging.NewLogrLogger(zl.WithName("crossplane-provider-linode"))
	if *debug {
	...
	kingpin.FatalIfError(controller.Setup(mgr, log), "Cannot setup Linode controllers")
